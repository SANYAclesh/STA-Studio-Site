...
const translations = {
    uk: {
        ...
        tlol_desc:
            "Головний герой Сандро Вотслей стикається з серйозною проблемою. Його друга Даніеля Самсонова викрали, а правоохоронні органи відмовляються допомагати. Сандро доведеться об'єднатися з різними людьми. Але чи всі вони говорять правду?",
        tsr_badge: "ГОНКИ · ВІДКРИТИЙ СВІТ",
        tsr_desc:
            'TSR — це перегони у відкритому світі з особливою фізикою. Вам доведеться дуже вміло "грати з кнопками", щоб утримати машину від занесення у різні боки!',
        crystal_badge: "СКОРО · Гача",
        crystal_soon: "// ІНФОРМАЦІЯ ВІДСУТНЯ — СЛІДКУЙТЕ ЗА НАМИ",
        store_label: "// МЕРЧА",
        store_title: "МАГАЗИН",
        store_all: "ПЕРЕГЛЯНУТИ ВСЕ →",
        item1_name: "ХУДІ TLOL",
        item2_name: "ПОСТЕР TSR",
        item3_name: "БРЕЛОК CRYSTAL REALMS",
        faq_label: "// ЗАПИТАННЯ",
        faq_title: "FAQ",
        ...
        btn_more: "ДОКЛАДНІШЕ",
        btn_play: "▶ ГРАТИ",
        btn_notify: "СПОВІСТИТИ МЕНЕ",
        // Modal texts
        m_tlol_tag: "// THE LIMIT OF LIES",
        m_tlol_title: "TLOL — Відкритий світ Трилер",
        m_tlol_body:
            "Головний герой Сандро Вотслей стикається з серйозною проблемою. Його друга Даніеля Самсонова викрали, а правоохоронні органи відмовляються співпрацювати. Гравцю доведеться об'єднатися з різними людьми. Але чи всі вони говорять правду? Хто насправді такий Даніель Самсонов? Як мафія пов'язана зі світовим урядом? За що насправді заарештували Дурова? Що приховує Діснейленд Париж? Чи є підтримка Європи для України змовою? Сандро має все це з'ясувати у пошуках свого друга.",
        m_tlol_genre: "Відкритий світ",
        m_tlol_status: "В РОЗРОБЦІ",
        m_tlol_platform: "ПК",
        m_tlol_play_title: "Незабаром",
        m_tlol_play_body:
            "TLOL наразі в розробці. Демо незабаром стане доступним. Підписуйтесь, щоб отримати сповіщення!",
        m_tsr_tag: "// THE STREET RACER",
        m_tsr_title: "TSR — Гонки у Відкритому Світі",
        m_tsr_body:
            "TSR — це гонки у відкритому світі з особливою фізикою. Вам доведеться дуже вміло керувати, щоб утримати машину від занесення! Опановуйте вулиці, відкривайте нові авто та домінуйте в кожній гонці підпільного кола міста.",
        m_tsr_genre: "ГОНКИ",
        m_tsr_status: "В РОЗРОБЦІ",
        m_tsr_platform: "ПК",
        m_tsr_play_title: "Незабаром",
        m_tsr_play_body:
            "TSR наразі в розробці. Демо-версія ще не доступна. Слідкуйте — ми оголосимо, коли можна буде сісти за кермо!",
        m_crystal_tag: "// CRYSTAL REALMS",
        m_crystal_title: "Crystal Realms — ???",
        m_crystal_body:
            "Наш найзагадковіший проєкт. Crystal Realms наразі на ранньому етапі розробки. Лор, геймплей і деталі розкриватимуться поступово. Одне точно — це буде щось незвичайне.",
        m_crystal_genre: "RPG / ???",
        m_crystal_status: "РАННЯ РОЗРОБКА",
        m_crystal_platform: "TBA",
        m_store_all_title: "Магазин відкривається",
        m_store_all_body:
            "Наш повноцінний магазин мерчу незабаром запуститься! Ми працюємо над ексклюзивним одягом, артпринтами та колекційними предметами для кожної з наших ігор. Підпишіться, щоб дізнатися першими!",
        m_item1_title: "Худі TLOL — $39.99",
        m_item1_body:
            "Преміальна якість худі з ексклюзивним артом The Limit Of Lies. Розміри S–XXL. Екологічний друк. Відправка по всьому світу.",
        m_item2_title: "Постер TSR — $14.99",
        m_item2_body:
            "Якісний арт-принт з ключовим візуалом TSR. Розміри A3/A2. Матовий папір 200 г/м². Ідеально для кімнати геймера.",
        m_item3_title: "Брелок Crystal Realms — $9.99",
        m_item3_body:
            "Металевий емальований брелок з логотипом Crystal Realms. Чудовий колекційний предмет для фанатів гри.",
        btn_wishlist: "ДО ВІШЛІСТА →",
        btn_notify_me: "🔔 СПОВІСТИТИ ПРО РЕЛІЗ",
        btn_to_cart: "ДО КОШИКА →",
        btn_sign_up: "ПІДПИСАТИСЬ НА ОНОВЛЕННЯ",
    },
    en: {
        nav_tlol: "TLOL",
        nav_tsr: "TSR",
        ...
        hero_btn1: "EXPLORE GAMES",
        hero_btn2: "VISIT STORE",
        scroll: "SCROLL",
        games_label: "// OUR PROJECTS",
        games_title: 'FEATURED <span class="accent">GAMES</span>',
        tlol_badge: "OPEN WORLD · THRILLER",
        tlol_desc:
            "The main character Sandro Wattsley is faced with a big problem. His friend Dandiel Samsonov has been kidnapped, and law enforcement agencies refuse to cooperate. Sandro will have to team up with a variety of people. But is everyone telling the truth?",
        tsr_badge: "RACING · OPEN WORLD",
        tsr_desc:
            'TSR is an open world race with very special physics. You will have to "play with the buttons" very well to keep the car from drifting in different directions!',
        crystal_badge: "COMING SOON · GACHA",
        crystal_soon: "// NO INFO AVAILABLE YET — STAY TUNED",
        store_label: "// MERCHANDISE",
        store_title: "STORE",
        store_all: "VIEW ALL →",
        item1_name: "TLOL HOODIE",
        item2_name: "TSR POSTER",
        item3_name: "CRYSTAL REALMS KEYCHAIN",
        faq_label: "// QUESTIONS",
        faq_title: "FAQ",
        ...
        m_tlol_genre: "Open World",
        m_tlol_status: "IN DEV",
        m_tlol_platform: "PC",
        m_tlol_play_title: "Coming Soon",
        m_tlol_play_body:
            "TLOL is currently in development. The demo will be available soon. Add it to your wishlist to get notified on launch day!",
        m_tsr_tag: "// THE STREET RACER",
        m_tsr_title: "TSR — Open World Racing",
        m_tsr_body:
            'TSR is an open world race with very special physics. You will have to "play with the buttons" very well to keep the car from drifting in different directions! Master the streets, unlock new vehicles, and dominate every race across the city\'s underground circuit.',
        m_tsr_genre: "RACING",
        m_tsr_status: "IN DEV",
        m_tsr_platform: "PC",
        m_tsr_play_title: "Coming Soon",
        m_tsr_play_body:
            "TSR is currently in development. The demo build is not yet available. Watch this space — we'll announce when you can get behind the wheel!",
        m_crystal_tag: "// CRYSTAL REALMS",
        m_crystal_title: "Crystal Realms — ???",
        m_crystal_body:
            "Our most mysterious project. Crystal Realms is currently in early development. Lore, gameplay, and details will be revealed gradually. One thing is certain — it will be unlike anything we've made before.",
        m_crystal_genre: "RPG / ???",
        m_crystal_status: "EARLY DEV",
        m_crystal_platform: "TBA",
        m_store_all_title: "Store Coming Soon",
        m_store_all_body:
            "Our full merch store is launching soon! We're working on exclusive apparel, art prints, and collectibles for each of our games. Sign up to be notified when we go live.",
        m_item1_title: "TLOL Hoodie — $39.99",
        m_item1_body:
            "Premium quality hoodie featuring exclusive The Limit Of Lies artwork. Available in sizes S–XXL. Printed with eco-friendly inks. Ships worldwide.",
        m_item2_title: "TSR Poster — $14.99",
        m_item2_body:
            "High-quality art print of the iconic TSR key visual. A3 / A2 sizes available. Printed on 200gsm matte paper. Perfect for any gamer's room.",
        m_item3_title: "CR Keychain — $9.99",
        m_item3_body:
            "Metal enamel keychain featuring the Crystal Realms logo. A beautiful collector's item for fans of the upcoming game.",
        btn_wishlist: "WISHLIST →",
        btn_notify_me: "🔔 NOTIFY ON RELEASE",
        btn_to_cart: "ADD TO CART →",
        btn_sign_up: "SIGN UP FOR UPDATES",
    },
};
...
function setLang(lang) {
    ...
    document
        ...
        .classList.toggle("active", lang === "uk");
    document
...
function getModalData(key) {
    ...
    const map = {
        tlol: {
            tag: t.m_tlol_tag,
            title: t.m_tlol_title,
            body: t.m_tlol_body,
            genre: t.m_tlol_genre,
            status: t.m_tlol_status,
            platform: t.m_tlol_platform,
            actions: `<button class="btn btn-primary" onclick="closeModal()">${t.btn_wishlist}</button>`,
        },
        "tlol-play": {
            tag: t.m_tlol_tag,
            title: t.m_tlol_play_title,
            body: t.m_tlol_play_body,
            genre: null,
...
document
    .querySelectorAll("a, button, .faq-q, .store-item, .game-card")
    .forEach((el) => {
...
/* ===== LOAD IMAGES (from images.js base64) ===== */
function loadImages() {
